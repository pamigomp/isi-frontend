...
describe("MenuController", function () {
    ...
    it("should set active class to current path", function () {
        expect(vm.getClass("root.exrat")).toEqual("active");
    });

    it("should not set active class to other paths", function () {
        expect(vm.getClass("root.subscription")).toEqual("");
        expect(vm.getClass("root.about")).toEqual("");
    });
});
